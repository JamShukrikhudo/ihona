...
return new class() extends Migration
{
    ...
    {
        foreach (['real_estate_document_signatures', 'real_estate_document_versions', 'real_estate_document_templates', 'real_estate_document_category_media', 'real_estate_document_categories'] as $table) {
