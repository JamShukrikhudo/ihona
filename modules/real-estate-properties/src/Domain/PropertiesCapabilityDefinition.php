...
final class PropertiesCapabilityDefinition
{
    ...
    {
        $labels = ['Address/location', 'Categories', 'Templates', 'Favorites', 'Saved searches', 'Community events', 'Reviews', 'Price alerts', 'Units', 'Characteristics', 'Tenure', 'Utilities', 'Features', 'Status', 'History', 'Keys', 'Property detail disclosures', 'Property comparisons', 'Property tax estimates', 'Walkability scores', 'Property QR codes', 'Property sharing'];
        $result = [];
