...
/**
 * WalkScore-style US-neighborhood-data feature — not relevant to the
 * Tajikistan market. Drops the reviews table first (holds the FK to
 * neighborhoods), then the property's neighborhood_id link, then the
 * neighborhoods table itself.
 */
return new class() extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('real_estate_properties', function (Blueprint $table): void {
            $table->dropIndex(['team_id', 'neighborhood_id']);
    ...
    public function down(): void
    {
        ...
        Schema::table('real_estate_properties', function (Blueprint $table): void {
            $table->foreignId('neighborhood_id')->nullable()->constrained('real_estate_neighborhoods')->nullOnDelete();
