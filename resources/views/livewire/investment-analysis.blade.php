    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <p class="text-2xl">{{ app(\App\Settings\GeneralSettings::class)->currencySymbol() }}{{ number_format($analysisResult['cash_flow'], 2) }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-2xl">{{ app(\App\Settings\GeneralSettings::class)->currencySymbol() }}{{ number_format($analysisResult['total_profit'], 2) }}</p>
            </div>
            <div>
                <p class="font-semibold">Future Value</p>
                <p class="text-2xl">{{ app(\App\Settings\GeneralSettings::class)->currencySymbol() }}{{ number_format($analysisResult['future_value'], 2) }}</p>
            </div>
        </div>
        <div class="mt-8">
