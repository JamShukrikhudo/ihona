                    ...
                    <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                        ...
                        <div class="mt-6 sm:mt-8 lg:mt-0">
                            ...
                            <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                                ...
                                {{-- Was data-modal-target="scheduleViewingModal": that dialog's
                                     body is gated @if(false), so it opened empty, and its form
                                     posts to a bookViewing() this component does not define. --}}
                                <a href="{{ route('property.book', $property->id) }}"
