...
return [
    ...
    'property' => [
        ...
        'buyer_types' => [
            'first_time_buyer' => 'Покупатель впервые',
            'home_mover' => 'Меняет жильё',
            'additional_property' => 'Дополнительная недвижимость',
        ],
        'actions' => [
            'favorite' => 'Избранное',
            'similar' => 'Похожие объекты',
            'similar_found' => ':count похожих объектов найдено',
            'tax_estimate' => 'Рассчитать налог',
            'tax_estimated' => 'Расчётный налог: :amount',
            'publish' => 'Опубликовать',
            'under_offer' => 'Предложение принято',
            'sold' => 'Отметить проданным',
            'withdraw' => 'Снять с публикации',
            'unit' => 'Добавить юнит',
            'key' => 'Добавить ключ',
        ],
        'statuses' => [
